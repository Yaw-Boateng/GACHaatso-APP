      ...
      <div className="max-w-md w-full">
        <div className="bg-theme-surface rounded-3xl shadow-soft-lg border border-theme-border p-8 md:p-10">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-bold text-theme-text tracking-tight mb-2">Welcome Back</h1>
            <p className="text-theme-muted">Sign in to your account to continue</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label htmlFor="password" className="text-sm font-semibold text-theme-text opacity-80">
                  Password
                </label>
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <label htmlFor="remember" className="text-sm text-theme-muted cursor-pointer select-none">
